...
import vn.mobile.id.core.ArchiveTimeStampChain;
...
public class ERSEvidenceRecord
{
        ...
        throws ERSException, TSPException
    {
        ...
        try
        {
            firstArchiveTimeStamp.validatePresent((ERSData) data, new Date());
        }
        catch (Exception e)
        {
            throw new ERSException("attempt to hash renew on invalid data");
        ...
        catch (IllegalArgumentException | ERSException e)
        {
            throw new ERSException(e.getMessage(), e);
        }
    }
