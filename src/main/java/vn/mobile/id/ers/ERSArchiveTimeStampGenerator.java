...
import org.bouncycastle.tsp.TimeStampRequest;
import org.bouncycastle.tsp.TimeStampResponse;
import vn.mobile.id.core.ArchiveTimeStamp;
import vn.mobile.id.core.ArchiveTimeStampSequence;
import vn.mobile.id.core.PartialHashtree;
import vn.mobile.id.core.TSTInfo;
...
public class ERSArchiveTimeStampGenerator {
    ...
    private ERSRootNodeCalculator rootNodeCalculator = (ERSRootNodeCalculator) new BinaryTreeRootCalculator();
    ...
    public List<ERSArchiveTimeStamp> generateArchiveTimeStamps(TimeStampResponse tspResponse)
            throws TSPException, ERSException, ERSException {
        IndexedPartialHashtree[] reducedHashTree = getPartialHashtrees();
